...
ver2.0.1 ← 【現在】リファクタリングの実施とライセンス認証の表示を実装
...
- RealmSwift
  アプリのバージョン１では全てのデータベースとして使用
  バージョン２ではカスタムマップの名称と色情報の保存のみに使用

- FirebaseAuthentication
  アプリバージョン２において匿名認証とアカウント作成に使用

- Cloud Firestore
  アプリバージョン２においてアカウント情報の保存と買い物リストの情報を保存

- Cloud Storage
  アプリバージョン２において買い物リストに添付する写真データを保存

- FirebaseFirestoreSwift
  アプリバージョン２においてSwiftのstructで作成したデータモデルをFirestoreのデータベースのドキュメントに変換

- LicensePlist
　アプリのv2.0.1で導入、外部ライブラリのラインセンス情報の表示のために使用
